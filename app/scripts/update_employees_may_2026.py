...
EMPLOYEES_TO_REMOVE = ['Jeff Trempe', 'Claire Conrardy']
EMPLOYEE_TO_ADD = {
    'employee_id': 'Matthieu Boglioni Beaulieu',
    'full_name': 'Matthieu Boglioni Beaulieu',
    'email': 'mboglionibeaulieu@activis.ca',
}
